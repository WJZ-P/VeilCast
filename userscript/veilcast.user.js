...
function seededPermutation(tileCount, seed) {
 ...
 */
function planGeometry({ width, height, tile, margin }) {
 ...
 */
function createRestorer(gl, params) {
...
function descriptionSettings(text) {
  const patterns = {
